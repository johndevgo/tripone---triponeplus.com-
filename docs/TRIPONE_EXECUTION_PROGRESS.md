...
| -------------------------------- | ------------ | ----------------------------------------------------------------------------------------------------------- |
| Multi-capability onboarding      | Verified     | Multi-select, any capability can be primary, editable page recipe, brand, offerings, ten themes and review. |
...
| Marketing resources              | Verified     | Original guides/comparisons and image-rich transfer, adventure, package, tour and rental presentation.      |
...
5. Push the reviewed release commit, deploy Vercel production, then verify the
