  ...
  return (
    <>
      ...
      <main className="overflow-hidden bg-[#f7faf9]">
            ...
            <div className="grid gap-6 lg:grid-cols-[.85fr_1.15fr] lg:items-end">
              <div>
                ...
                <h2
                  ...
                  className="marketing-title-light mt-5"
                >
          ...
          <div className="mx-auto max-w-7xl">
            <div className="max-w-3xl">
              ...
              <p className="mt-5 max-w-2xl text-lg leading-8 text-[#60746d]">
                No blank canvas and no mystery generation. Every output comes
                from typed information and visible rules you can edit.
              </p>
            </div>
            <ol className="mt-12 grid gap-5 lg:grid-cols-4">
              {[
                ...
                >
                  ...
                  <p className="mt-3 text-sm leading-6 text-[#647a72]">
                    {copy}
                  </p>
                </li>
              ))}
        ...
        <section
          className="app-bg px-5 py-24 text-white sm:py-28"
          id="platform"
        >
          <div className="mx-auto max-w-7xl">
            ...
            <div className="relative min-h-[30rem] overflow-hidden rounded-[2rem]">
              ...
              <div className="absolute inset-x-7 bottom-7 text-white sm:inset-x-9 sm:bottom-9">
                ...
                <h2 className="mt-4 max-w-xl text-3xl font-semibold tracking-[-.03em] sm:text-4xl">
                  Technology when you want control. People when you want
                  support.
                </h2>
              </div>
            </div>
            ...
            <div className="flex flex-col justify-between gap-6 sm:flex-row sm:items-end">
              <div>
                ...
                <p className="mt-4 max-w-xl leading-7 text-white/50">
                  Explore {resources.length} practical guides, operating
                  playbooks and source-linked platform comparisons written for
                  tourism teams.
                </p>
              </div>
              <Link
